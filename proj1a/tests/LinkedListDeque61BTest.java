...
public class LinkedListDeque61BTest {
    ...
    public void getTest() {
        ...
        lld1.addLast(9);
        assertThat(lld1.get(0)).isEqualTo(9);
        lld1.addFirst(5);
        assertThat(lld1.get(0)).isEqualTo(5);

        assertThat(lld1.get(10000)).isEqualTo(null);
    ...
    public void getRecursiveTest() {
        ...
        lld1.addLast(9);
        assertThat(lld1.getRecursive(0)).isEqualTo(9);
        lld1.addFirst(5);
        assertThat(lld1.getRecursive(0)).isEqualTo(5);

        assertThat(lld1.getRecursive(10000)).isEqualTo(null);
