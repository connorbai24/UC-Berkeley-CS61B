...
public class Model {
    ...
    public boolean emptySpaceExists() {
        int sized = board.size(); // size() will count from 1 instead of 0.
        ...
        for (int i=0; i < Size; i++) {
            for (int j=0; j < Size; j++) {
                ...
                if (i < Size - 1 && j < Size - 1) {
                    if ((board.tile(i+1, j) == null) || (board.tile(i, j+1)) == null) {
                        return true;
    ...
    public void tilt(Side side) {
        ...
        board.setViewingPerspective(dir);
