...
public class TestOneWordK0Hyponyms {
    ...
    public static final String SMALL_SYNSET_FILE = "data/wordnet/synsets14.txt";
    public static final String SMALL_HYPONYM_FILE = "data/wordnet/hyponyms14.txt";
...
//    }
    ...
    public void testActK0() {
        NgordnetQueryHandler studentHandler = AutograderBuddy.getHyponymsHandler(
                TestOneWordK0Hyponyms.WORDS_FILE, TOTAL_COUNTS_FILE, SMALL_SYNSET_FILE, SMALL_HYPONYM_FILE);
