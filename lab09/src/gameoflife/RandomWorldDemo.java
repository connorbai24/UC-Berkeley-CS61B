...
public class RandomWorldDemo {
    ...
    // Random is the Pseudorandom Number Generator, which means if SEED is the same, the result is also same.
    // nextInt gives specific values.
    ...
    public static void fillWithRandomTiles(TETile[][] tiles) {
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                tiles[x][y] = randomTile(); // for each tile
            }
        }
    }
